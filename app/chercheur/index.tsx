...
import { BackHandler, TouchableWithoutFeedback, Image, Platform, View } from 'react-native';
...
export default function AdminIndex() {
  const [storedFullName, setStoredFullName] = useState<string | null>(null);
  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        ...
        setStoredFullName(fullName || 'Utilisateur');
      } catch (error) {
      ...
      <Div flex={1} bg="white" justifyContent="center" alignItems="center">
        ...
        <Div alignItems="center" w="90%" mb="xl">
          <Button
            ...
            fontWeight="bold"
            mb="md"
            onPress={() => router.push('/chercheur/listprojets')}
          >
            Insérer le temps consacré à une activité
          </Button>
          <Button
            w="100%"
            bg="green500"
            ...
            fontWeight="bold"
            mb="md"
            onPress={() => router.push('/chercheur/profile')}
          >
            Historiques
          </Button>
          <Button
            ...
            fontWeight="bold"
            mb="md"
            onPress={() => router.push('/chercheur/rapportchercheur')}
          >
